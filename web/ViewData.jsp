  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="ViewData.jsp">View Data</a></li>
                      ...
                      <td><%=r.getString("email")%></td>
                       <td><%=r.getString("mobile")%></td>
                        <td><%=r.getString("address")%></td>
                         <td><a href="ViewData.jsp">Back</a></td> 
                 </tr>  
                ...
                <%try{
                    ...
                    while(r.next()){
                      ...
                      <tr>
                          ...
                          <td><a href="ViewData.jsp?oid=<%=id%>"><%=r.getString("owner_name")%></a></td>
                      <td><%=r.getString("fname")%></td>
                      <td><textarea cols="40" rows="15"><%=r.getString("data")%></textarea></td>
                          
                           <td><%=r.getString("date")%></td>
                           <td><a  href="ViewData.jsp?fid=<%=r.getString("fid")%>">View Cipher</a></td>
                      </tr>  
